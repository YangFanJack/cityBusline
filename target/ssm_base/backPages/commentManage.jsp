        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item">
                <a class="nav-link" href="#" role="button">
                    你好，管理员：<b>${sessionScope.managerAccount}</b>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#" role="button">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">评论管理：查看所属贴子，删除</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                    <c:forEach items="${commentList}" var="keyword" varStatus="id">
                                        <tr>
                                            <td>${id.index+1}</td>
                                            <td>${keyword.content}</td>
                                            <td>${keyword.time}</td>
                                            <td>${keyword.user.nickName}</td>
                                            <td>${keyword.post.title}</td>
                                            <td>
                                                <a class="btn btn-primary btn-sm"
                                                   href="${pageContext.request.contextPath}/findPostById?id=${keyword.post.id}">
                                                    <i class="fas fa-folder">
                                                    </i>
                                                    查看
                                                </a>
                                                <a class="btn btn-danger btn-sm"
                                                   href="${pageContext.request.contextPath}/deleteComment?id=${keyword.id}">
