                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <button type="button" class="btn btn-primary float-sm-right" data-toggle="modal"
                                data-target="#modal_2">发布通知</button>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            </section>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">通知管理：查看通知，发布通知，删除通知</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                        ...
                                        <c:forEach items="${noticeList}" var="keyword" varStatus="id">
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <c:if test="${keyword.type==3}">
                                                        公交通知
                                                    </c:if>
                                                    <c:if test="${keyword.type==4}">
                                                        政府通知
                                                    </c:if>
                                                </td>
                                                <td>
                                                    <a class="btn btn-primary btn-sm"
                                                       href="${pageContext.request.contextPath}/findNoticeById?id=${keyword.id}">
                                                        <i class="fas fa-folder">
                                                        </i>
                                                        查看
                                                    </a>
                                                    <a class="btn btn-danger btn-sm"
                                                       href="${pageContext.request.contextPath}/deleteNotice?id=${keyword.id}">
                        ...
                        <form action="${pageContext.request.contextPath}/addNotice" method="post">
                            <div class="modal-body">
                                ...
                                <select class="form-control" name="type">
                                    ...
                                    <option value="2">旅游广告</option>
                                    <option value="3">公交通知</option>
                                    <option value="4">政府通知</option>
                                </select>
                                <label for="doNotice">通知内容</label>
                                <textarea id="doNotice" name="content" placeholder="从这里发布通知"></textarea>
                            </div>
