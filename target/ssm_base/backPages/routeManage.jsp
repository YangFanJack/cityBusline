      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="${pageContext.request.contextPath}/backPages/routeManage.jsp" class="nav-link">
            ...
            <li class="nav-item">
              <a href="${pageContext.request.contextPath}/backPages/siteManage.jsp" class="nav-link">
                <i class="nav-icon fas fa-edit"></i>
                <p>
                  站点管理
                </p>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>6:00/21:00</td>
                        <td>2元</td>
                        <td>xx—>xx—>xx—>xx—>xx—>xx—>xx—>xx—>xx—>xx—>xx—>xx—>xx—>xx—>xx—>xx</td>
                        <td>
                          <a class="btn btn-info btn-sm" href="#" data-toggle="modal" data-target="#modal_3">
              ...
              <div class="col-lg-4">
                <form>
                  ...
                  <div class="form-group">
                    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="线路编号">
                  </div>
                  <div class="input-group">
                    ...
                    <input id="yPos" type="number" class="form-control" placeholder="y坐标(0—19)"
                      aria-label="Recipient's username" aria-describedby="button-addon2">
                    <div class="input-group-append">
                      <button id="addPoint" class="btn btn-outline-secondary" type="button"
                        id="button-addon2">添加拐点</button>
                    </div>
                  </div>
  ...
  <script>
    ...
    $("#addPoint").click(function () {
      ...
      if (x === "" || y === "") {
        ...
        var Pos = x + "," + y;
        var content = $('<input type="text" readonly value="' + Pos + '" class="form-control col-3">');
