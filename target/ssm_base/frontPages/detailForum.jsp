        ...
        <div class="container py-lg-4 py-md-3">
            ...
            <div class="row">
                <div class="col-lg-8 most-recent">
                        ...
                        <div class="col-md-12 item">
                            <div class="card">
                                <div class="card-body p-0 blog-details">
                                    <h4 class="blog-desc">${post.title}</h4>
                                    <div class="author align-items-center mt-3 mb-1">
                                        ${post.user.nickName}(${post.user.email})
                                    </div>
                                    <ul class="blog-meta">
                                        <li class="meta-item blog-lesson">
                                            <span class="meta-value"> ${post.time} </span>
                                        </li>
                                    </ul>
                                    <br>
                                    <!-- notice content -->
                    ...
                    <hr>
                    <h4 class="blog-desc" style="font-weight: bold;">评论</h4>
                    <br>
                    ...
                    <div class="row">
                        <div class="col-md-12 item">
                            <c:forEach items="${post.commentList}" var="keyword" varStatus="id">
                                <div class="card">
                                    <div class="card-body p-0 blog-details">
                                        <ul class="blog-meta">
                                            <li class="meta-item blog-lesson">
                                            ...
                                            <li class="meta-item blog-lesson">
                                                评论用户：<span style="color: rgb(90, 90, 212);">${keyword.user.nickName}(${keyword.user.email})</span>
                                            </li>
                                        </ul>
                                        <span class="blog-desc">${keyword.content}
                                    </span>
                                    </div>
                                </div>
                                <br>
                    ...
                    <div class="row">
                        <div class="col-md-12 item">
                            <form method="get" action="${pageContext.request.contextPath}/addComment">
                                <input name="postId" type="text" value="${post.id}" style="display: none">
                                <div class="modal-body">
                                    <textarea id="doComment" name="content" placeholder="对这篇贴子发表你的看法吧！"></textarea>
                                </div>
