...
<body>
    ...
    <nav id="breadcrumbs" class="breadcrumbs">
        <div class="container page-wrapper">
            <form action="${pageContext.request.contextPath}/findPostByUserId" method="GET">
        ...
        <div class="container py-lg-4 py-md-3">
            ...
            <div class="row">
                <div class="col-lg-8 most-recent">
                    <h3 class="section-title-left">我的贴子</h3>
                    <div class="row">
                        <c:if test="${postPageInfo.list.size() == 0}">
                            您还没有贴子~~~
                        </c:if>
                        <div class="col-md-12 item">
                            <c:forEach items="${postPageInfo.list}" var="keyword" varStatus="id">
                                <div class="card">
                                    <div class="card-body p-0 blog-details">
                                        <a href="${pageContext.request.contextPath}/findPostById?id=${keyword.id}"
                                            class="blog-desc">${keyword.title}</a>
                                        <ul class="blog-meta">
                                            ...
                                            <li class="meta-item blog-lesson">
                                                <a
                                                    href="${pageContext.request.contextPath}/deletePost?id=${keyword.id}"><button
                    ...
                    <div class="pagination-wrapper mt-5">
                        <ul class="page-pagination">
                            <c:forEach var="i" begin="1" end="${postPageInfo.pages}">
                                <c:if test="${postPageInfo.pageNum == i }">
                                    <li><a class="page-numbers"
                                            href="${pageContext.request.contextPath}/findPostByUserId?page=${i}&searchString=${searchString}"><span
                                                aria-current="page" class="page-numbers current">${i}</span></a></li>
                                </c:if>
                                <c:if test="${postPageInfo.pageNum != i }">
                                    <li><a class="page-numbers"
                                            href="${pageContext.request.contextPath}/findPostByUserId?page=${i}&searchString = ${searchString}">${i}</a>
                                    </li>
                                </c:if>
                            </c:forEach>
                            <li><a class="next"
                                    href="${pageContext.request.contextPath}/findPostByUserId?page=${postPageInfo.pageNum+1}&pages=${postPageInfo.pages}&searchString=${searchString}"><span
