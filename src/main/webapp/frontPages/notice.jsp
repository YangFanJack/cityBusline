...
<body>
    ...
    <nav id="breadcrumbs" class="breadcrumbs">
        <div class="container page-wrapper">
            <form action="${pageContext.request.contextPath}/findAllNotice" method="GET">
        ...
        <div class="container py-lg-4 py-md-3">
            ...
            <div class="row">
                <div class="col-lg-8 most-recent">
                    <h3 class="section-title-left">公交通知</h3>
                    <div class="row">
                        <c:if test="${noticePageInfo.list.size() == 0}">
                            一篇通知也没有~~~
                        </c:if>
                        <div class="col-md-12 item">
                            <c:forEach items="${noticePageInfo.list}" var="keyword" varStatus="id">
                                <div class="card">
                                    <div class="card-body p-0 blog-details">
                                        <a href="${pageContext.request.contextPath}/findNoticeById?id=${keyword.id}" class="blog-desc">${keyword.title}</a>
                                        <ul class="blog-meta">
                    ...
                    <div class="pagination-wrapper mt-5">
                        <ul class="page-pagination">
                            <c:forEach  var="i" begin="1" end="${noticePageInfo.pages}">
                                <c:if test="${noticePageInfo.pageNum == i }">
                                    <li><a class="page-numbers" href="${pageContext.request.contextPath}/findAllNotice?page=${i}&searchString=${searchString}"><span aria-current="page" class="page-numbers current">${i}</span></a></li>
                                </c:if>
                                <c:if test="${noticePageInfo.pageNum != i }">
                                    <li><a class="page-numbers" href="${pageContext.request.contextPath}/findAllNotice?page=${i}&searchString=${searchString}">${i}</a></li>
                                </c:if>
                            </c:forEach>
                            <li><a class="next" href="${pageContext.request.contextPath}/findAllNotice?page=${noticePageInfo.pageNum+1}&pages=${noticePageInfo.pages}&searchString=${searchString}"><span class="fa fa-angle-right"></span></a></li>
                        </ul>
                    </div>
                    <!-- //pagination -->
                </div>
