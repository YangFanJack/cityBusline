...
<body>
    ...
    <section class="w3l-contact-2 py-5">
        <div class="container py-lg-5 py-md-4">
            <h3 class="section-title-left">用户注册 </h3>
            <div class="contact-grids d-grid">
                <div class="contact-left">
                    <h3 class="mb-3">用户注册注意事项</h3>
                ...
                <div class="contact-right">
                    <form action="${pageContext.request.contextPath}/userRegister" method="post" class="signin-form">
                        <div class="input-grids">
                            <input type="email" name="email" id="email" placeholder="邮箱(注册需邮箱认证)" class="contact-input"
                                required="" />
                            <input type="password" name="password" id="password" placeholder="密码" class="contact-input"
                                required="" />
                            <input type="password" name="rePassword" id="rePassword" placeholder="确认密码"
                                class="contact-input" required="" />
                            <input type="text" name="nickName" id="nickName" placeholder="用户昵称" class="contact-input"
                                required="" />
                        </div>
                        <button type="submit" class="btn btn-style btn-outline">注册</button>
                        <a href="${pageContext.request.contextPath}/frontPages/login.jsp"
                            style="margin-left: 280px;">前往登录</a>
                    </form>
                </div>
            </div>
        </div>
