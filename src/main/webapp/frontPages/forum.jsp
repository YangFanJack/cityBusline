...
<body>
    ...
    <nav id="breadcrumbs" class="breadcrumbs">
        <div class="container page-wrapper">
            <form action="${pageContext.request.contextPath}/findAllPost" method="GET">
        ...
        <div class="container py-lg-4 py-md-3">
            ...
            <div class="row">
                <div class="col-lg-8 most-recent">
                    <h3 class="section-title-left">公交论坛</h3>
                    <div class="row">
                            ...
                            <c:forEach var="i" begin="1" end="${postPageInfo.pages}">
                                <c:if test="${postPageInfo.pageNum == i }">
                                    <li><a class="page-numbers"
                                            href="${pageContext.request.contextPath}/findAllPost?page=${i}&searchString = ${searchString}"><span
                                                aria-current="page" class="page-numbers current">${i}</span></a></li>
                                </c:if>
                                <c:if test="${postPageInfo.pageNum != i }">
                                    <li><a class="page-numbers"
                                            href="${pageContext.request.contextPath}/findAllPost?page=${i}&searchString = ${searchString}">${i}</a>
                                    </li>
                                </c:if>
                            </c:forEach>
                            <li><a class="next"
                                    href="${pageContext.request.contextPath}/findAllPost?page=${postPageInfo.pageNum+1}&pages=${postPageInfo.pages}&searchString=${searchString}"><span
                ...
                <div class="col-lg-4 trending mt-lg-0 mt-5 mb-lg-5">
                    <div class="pos-sticky">
                        <h3 class="section-title-left">最近贴子 </h3>
