...
<body>
    ...
    <section class="w3l-contact-2 py-5">
        <div class="container py-lg-5 py-md-4">
            <h3 class="section-title-left">修改密码 </h3>
            <div class="contact-grids d-grid">
                <div class="contact-left">
                    <h3 class="mb-3">修改密码注意事项</h3>
                ...
                <div class="contact-right">
                    <form action="${pageContext.request.contextPath}/userModifyPasswd" method="post" class="signin-form">
                        <div class="input-grids">
                            ...
                            <input type="password" name="rePassword" id="rePassword" placeholder="确认新密码"
                                class="contact-input" required="" />
                            <input type="text" name="vCode" id="vCode" placeholder="前往邮箱获取验证码"
                                class="contact-input" />
                        </div>
                        <button type="submit" class="btn btn-style btn-outline">确认修改</button>
                        <button type="button" id="getVCode" class="btn btn-style btn-outline">获取验证码</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        $("#getVCode").click(function (){
            $.ajax({
                ...
                type: "POST",
                url : "${pageContext.request.contextPath}/getVCode",
