                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">贴子管理：查看贴子，编辑贴子，删除贴子</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <c:forEach items="${postList}" var="keyword" varStatus="id">
                                            <tr>
                                                ...
                                                <td>${keyword.time}</td>
                                                <td>
                                                    <a class="btn btn-primary btn-sm" href="${pageContext.request.contextPath}/findPostById?id=${keyword.id}">
                                                        <i class="fas fa-folder">
                                                        </i>
                                                        查看
                                                    </a>
                                                    <a class="btn btn-danger btn-sm"
                                                       href="${pageContext.request.contextPath}/deletePost2?id=${keyword.id}">
