                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <button type="button" class="btn btn-primary float-sm-right" data-toggle="modal"
                                data-target="#modal_2">添加管理员</button>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            </section>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">管理员管理：添加管理员，删除管理员</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                        <c:forEach items="${managerList}" var="keyword" varStatus="id">
                                            <tr>
                                                <td>${id.index+1}</td>
                                                <td>${keyword.account}</td>
                                                <td>
                                                    <a class="btn btn-danger btn-sm"
                                                       href="${pageContext.request.contextPath}/deleteManager?id=${keyword.id}">
