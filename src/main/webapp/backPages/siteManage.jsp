...
<body class="hold-transition sidebar-mini">
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">公交站点管理：编辑车站，删除车站</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                        <c:forEach items="${stationList}" var="keyword" varStatus="id">
                                            <tr>
                                                <td>${id.index+1}</td>
                                                <td>${keyword.stationName}</td>
                                                <td>
                                                <c:forEach items="${keyword.busLines}" var="keyword2" varStatus="id2">
                                                    ${keyword2.lineNum}路;
                                                </c:forEach>
                                                </td>
                                                <td>
                                                    <a onclick="asyncFind(${keyword.id})" class="btn btn-info btn-sm" href="#" data-toggle="modal"
                                                       data-target="#modal_2">
                                                        <i class="fas fa-pencil-alt">
                                                        </i>
                                                        编辑
                                                    </a>
                                                    <a class="btn btn-danger btn-sm" href="${pageContext.request.contextPath}/deleteStation?id=${keyword.id}">
  ...
  <section class="content">
        ...
        <div class="modal fade" id="modal_2">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="${pageContext.request.contextPath}/updateStation" method="get">
                            <input id="stationId" name="stationId" type="number" class="form-control" style="display: none">
                            车站名：
                            <div class="form-group">
                                <input id="stationName" name="stationName" type="text" class="form-control">
                            </div>
                            <br>
                            <button type="submit" class="btn btn-primary col-12">更新车站</button>
                        </form>
                    </div>
                </div>
                <!-- /.modal-content -->
    ...
    <script>
        ...
        function asyncFind(stationId) {
            $.ajax({
                data:{"stationId":stationId},
                type: "POST",
                url : "${pageContext.request.contextPath}/findStationById",
                success : function (msg){
                    $("#stationId").val(msg.id);
